<?php
/**
 * Single event local list information box (used for elementor)
 *
 * @since  3.1.32
 */

if (has_event_local_ids($event_id) && !is_event_online($event_id)) :
    ...
    <div class="wpem-local-wrapper wpem-listing-accordion-panel active" style="display: block;">
        ...
        $local_id = get_event_local_ids($event_id); 
                    ...
                    <div class="wpem-col-md-9 wpem-col-sm-12">
                        <div class="wpem-local-infomation-wrapper">
                            ...
                            <div class="wpem-local-description"><?php 
                                $content = apply_filters('wpem_the_content',$local->post_content);
                                if(!empty($content)){
                                echo wp_kses_post( $content );}?>
                            </div>
                            <!-- local social link section start-->
...
<?php elseif (get_event_local_name($event_id) != '' && !is_event_online($event_id)) : ?>
                            ...
                            <div class="wpem-local-inner-wrapper">
                                <div class="wpem-row">
                                    <div class="wpem-col-md-12 wpem-col-sm-12">
                                        <div class="wpem-local-name wpem-heading-text">
                                            <?php display_event_local_name($event_id); ?></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
