...
$options = array(
		...
		'event_manager_dj_dashboard_page_id',
		...
		'event_manager_submit_dj_form_fields',
		'event_manager_submit_dj_form_page_id',
		'event_manager_submit_local_form_fields',
		'event_manager_submit_local_form_page_id',
		'event_manager_timepicker_format',
		'event_manager_timepicker_step',
		'event_manager_timezone_setting',
		'event_manager_local_dashboard_page_id',
		'event_manager_event_locals_page_id',
